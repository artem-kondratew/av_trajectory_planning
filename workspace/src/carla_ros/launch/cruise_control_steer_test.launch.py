...
host_params = [os.path.join(get_package_share_directory(package_name), 'config', 'params_host_steering_test.yaml')]
...
def generate_launch_description():
    ...
    steer_test_node = Node(
        package=adas_package,
        executable='steer_test_node',
        name='steer_test_node',
        output='screen',
        arguments=['--ros-args', '--log-level', LaunchConfiguration('log_level')],
        parameters=[
            LaunchConfiguration('params_file'),
