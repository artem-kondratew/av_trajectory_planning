...
host_params = [os.path.join(get_package_share_directory(package_name), 'config', 'params_host_stanley.yaml')]
...
def generate_launch_description():
    ...
    stanley_state_topic_arg = DeclareLaunchArgument(
        'stanley_state_topic',
        default_value='/carla/hero/stanley_state'
    )
    ...
    stanley_node = Node(
        ...
        parameters=[
            ...
            {
                'allow_driving': False,
                'stanley_state_topic': LaunchConfiguration('stanley_state_topic'),
    ...
    ld.add_action(stanley_state_topic_arg)
