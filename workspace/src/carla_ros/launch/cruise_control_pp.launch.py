...
host_params = [os.path.join(get_package_share_directory(package_name), 'config', 'params_host_pp.yaml')]
...
def generate_launch_description():
    ...
    pp_state_topic_arg = DeclareLaunchArgument(
        'pp_state_topic',
        default_value='/carla/hero/pp_state'
    )
    ...
    pp_node = Node(
        ...
        parameters=[
            LaunchConfiguration('params_file'),
            {
                ...
                'pp_state_topic': LaunchConfiguration('pp_state_topic'),
            }
        ],
    )
    ...
    ld.add_action(pp_state_topic_arg)
